...
from sandbox.asa.policies.gridworld_policies import GridworldTargetPolicy, GridworldStepPolicy, GridworldRandomPolicy
...
__all__ = ['HierarchicalPolicy',
           ...
           'GridworldTargetPolicy', 'GridworldStepPolicy', 'GridworldRandomPolicy',
